...
export class RootView extends WFComponent<RootPresenter> {
    ...
    render() {
        const moduleView = WFViewFactory.createView(this.props.presenter.state.module)
        return <>
            <div className={style.View}>
                <span className={style.Title}>Exemplo de Webflow</span>
                <div className={style.Bar}>
                    <button className={style.BtnFirst} onClick={this.handleModule1Click}>Module1</button>
