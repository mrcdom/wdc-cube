...
This sits beside [cube-tutorial-react](../cube-tutorial-react/README.md) and
[cube-tutorial-angular](../cube-tutorial-angular/README.md) because it plays the
same part they do: it drives
[cube-tutorial-core](../cube-tutorial-core/README.md) without changing a line of
...
```bash
pnpm compile     # builds wdc-cube, wdc-cube-test and cube-tutorial-core
