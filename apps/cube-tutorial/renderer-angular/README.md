# cube-tutorial/renderer-angular
...
```bash
pnpm install
pnpm compile              # builds wdc-cube and cube-tutorial/presentation
...
equivalent for. `cube-tutorial/presentation` is therefore compiled to `lib/` rather than
...
[cube-tutorial/presentation-test](../presentation-test/README.md).
