...
let ui: Rendered<ItemView> | undefined
...
describe('ItemView', () => {
    describe('drawing the scope', () => {
        it('shows the title, unchecked and unmarked while active', () => {
            ui = renderView(ItemView, anItem({ title: 'Write the tests' }))
        ...
        it('marks the row completed and checks the box', () => {
            ui = renderView(ItemView, anItem({ completed: true }))
        ...
        it('swaps the row for an edit field carrying the current title', () => {
            ui = renderView(ItemView, anItem({ editing: true, title: 'Go to school' }))
    ...
    describe('firing actions', () => {
        it('toggles on the checkbox', () => {
            ...
            ui.dispatch(ui.get('input.toggle'), new Event('change', { bubbles: true }))
